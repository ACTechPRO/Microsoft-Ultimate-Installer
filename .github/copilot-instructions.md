...
| ----- | --------- | ----------- |
| `deepseek-coder-v2` | Code | Analysis, refactoring, debugging |
| `llama3.1` | General Reasoning | Planning, explanations, chat |

**Configuration**: Models run locally via Ollama on the user's RTX 4080. Model directory: `D:\TechAI\TechAgents`.
...
> **Auto-generated by sync-rules.ps1** on 2025-12-20 14:03:58
